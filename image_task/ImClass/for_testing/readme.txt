...
2. Installing the ImClass Package

A. Change to the directory that contains the file setup.py and the subdirectory ImClass. 
...
3. Using the ImClass Package

The ImClass package is on your Python path. To import it into a Python script or session, 
execute:
