...
2. Installing the MakeCNN Package

A. Change to the directory that contains the file setup.py and the subdirectory MakeCNN. 
...
3. Using the MakeCNN Package

The MakeCNN package is on your Python path. To import it into a Python script or session, 
execute:
